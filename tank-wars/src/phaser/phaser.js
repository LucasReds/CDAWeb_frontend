...
class TankWarsScene extends Phaser.Scene {
  ...
  preload() {
    this.load.image("tank", "/TankBody.png");
    this.load.image("turret", "/TankTurret.png");
    this.load.image("bullet", "/TankBullet.png");
    this.load.image("background", "/game_background.jpg");
  }
